...
/**
 * ListingIdFilesBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListingIdFilesBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'listing_id_files_body';
...
'rank' => 'getRank'    ];
     ...
     * Sets file
     *
     * @param string $file A binary file to upload.
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name The file name string of a file to upload
     *
     * @return $this
     */
