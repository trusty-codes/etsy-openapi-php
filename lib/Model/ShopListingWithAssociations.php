...
/**
 * ShopListingWithAssociations Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShopListingWithAssociations implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShopListingWithAssociations';
...
'taxonomy_id' => 'int',
'shipping_profile' => 'AllOfShopListingWithAssociationsShippingProfile',
'user' => 'AllOfShopListingWithAssociationsUser',
'shop' => 'AllOfShopListingWithAssociationsShop',
'images' => '\Swagger\Client\Model\AllOfShopListingWithAssociationsImagesItems[]',
'videos' => '\Swagger\Client\Model\AllOfShopListingWithAssociationsVideosItems[]',
'inventory' => 'AllOfShopListingWithAssociationsInventory',
'production_partners' => '\Swagger\Client\Model\AllOfShopListingWithAssociationsProductionPartnersItems[]',
'skus' => 'string[]',
'translations' => '\Swagger\Client\Model\AllOfShopListingWithAssociationsTranslationsItems[]',
'views' => 'int'    ];
...
'shipping_profile' => 'setShippingProfile',
'user' => 'setUser',
'shop' => 'setShop',
'images' => 'setImages',
'videos' => 'setVideos',
'inventory' => 'setInventory',
'production_partners' => 'setProductionPartners',
'skus' => 'setSkus',
...
'shipping_profile' => 'getShippingProfile',
'user' => 'getUser',
'shop' => 'getShop',
'images' => 'getImages',
'videos' => 'getVideos',
'inventory' => 'getInventory',
'production_partners' => 'getProductionPartners',
'skus' => 'getSkus',
...
self::ITEM_DIMENSIONS_UNIT_INCHES,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['shipping_profile'] = isset($data['shipping_profile']) ? $data['shipping_profile'] : null;
        ...
        $this->container['production_partners'] = isset($data['production_partners']) ? $data['production_partners'] : null;
     ...
     * Gets price
     *
     * @return AllOfShopListingWithAssociationsPrice
     */
     ...
     * Sets price
     *
     * @param AllOfShopListingWithAssociationsPrice $price The positive non-zero price of the product. (Sold product listings are private) Note: The price is the minimum possible price. The [`getListingInventory`](/documentation/reference/#operation/getListingInventory) method requests exact prices for available offerings.
     *
     * @return $this
     */
    ...
    /**
     * Gets shipping_profile
     *
     * @return AllOfShopListingWithAssociationsShippingProfile
     */
    public function getShippingProfile()
    {
        return $this->container['shipping_profile'];
    }

    /**
     * Sets shipping_profile
     *
     * @param AllOfShopListingWithAssociationsShippingProfile $shipping_profile An array of data representing the shipping profile resource.
     *
     * @return $this
     */
    public function setShippingProfile($shipping_profile)
    {
        $this->container['shipping_profile'] = $shipping_profile;
     ...
     * Gets user
     *
     * @return AllOfShopListingWithAssociationsUser
     */
     ...
     * Sets user
     *
     * @param AllOfShopListingWithAssociationsUser $user Represents a single user of the site
     *
     * @return $this
     */
     ...
     * Gets shop
     *
     * @return AllOfShopListingWithAssociationsShop
     */
     ...
     * Sets shop
     *
     * @param AllOfShopListingWithAssociationsShop $shop A shop created by an Etsy user.
     *
     * @return $this
     */
     ...
     * Gets images
     *
     * @return \Swagger\Client\Model\AllOfShopListingWithAssociationsImagesItems[]
     */
     ...
     * Sets images
     *
     * @param \Swagger\Client\Model\AllOfShopListingWithAssociationsImagesItems[] $images Represents a list of listing image resources, each of which contains the reference URLs and metadata for an image
     *
     * @return $this
     */
     ...
     * Gets videos
     *
     * @return \Swagger\Client\Model\AllOfShopListingWithAssociationsVideosItems[]
     */
     ...
     * Sets videos
     *
     * @param \Swagger\Client\Model\AllOfShopListingWithAssociationsVideosItems[] $videos The single video associated with a listing.
     *
     * @return $this
     */
     ...
     * Gets inventory
     *
     * @return AllOfShopListingWithAssociationsInventory
     */
     ...
     * Sets inventory
     *
     * @param AllOfShopListingWithAssociationsInventory $inventory An enumerated string that attaches a valid association. Default value is null.
     *
     * @return $this
     */
    ...
    /**
     * Gets production_partners
     *
     * @return \Swagger\Client\Model\AllOfShopListingWithAssociationsProductionPartnersItems[]
     */
    public function getProductionPartners()
    {
        return $this->container['production_partners'];
    }

    /**
     * Sets production_partners
     *
     * @param \Swagger\Client\Model\AllOfShopListingWithAssociationsProductionPartnersItems[] $production_partners Represents a list of production partners for a shop.
     *
     * @return $this
     */
    public function setProductionPartners($production_partners)
    {
        $this->container['production_partners'] = $production_partners;
     ...
     * Sets skus
     *
     * @param string[] $skus A list of SKU strings for the listing. SKUs will only appear if the requesting user owns the shop and a valid matching OAuth 2 token is provided. When requested without the token it will be an empty array.
     *
     * @return $this
     */
     ...
     * Gets translations
     *
     * @return \Swagger\Client\Model\AllOfShopListingWithAssociationsTranslationsItems[]
     */
     ...
     * Sets translations
     *
     * @param \Swagger\Client\Model\AllOfShopListingWithAssociationsTranslationsItems[] $translations An array of translations for the listing. Default value is an empty array.
     *
     * @return $this
     */
