 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class TransactionReview implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'TransactionReview';
...
'updated_timestamp' => 'getUpdatedTimestamp'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['review'] = isset($data['review']) ? $data['review'] : '';
     ...
     * Sets transaction_id
     *
     * @param int $transaction_id The ID of the ShopReceipt Transaction that the TransactionReview belongs to.
     *
     * @return $this
     */
