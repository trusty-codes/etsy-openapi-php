 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ShopShippingProfileUpgrade implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ShopShippingProfileUpgrade';
...
'rank' => 'int',
'language' => 'string',
'price' => 'AllOfShopShippingProfileUpgradePrice',
'secondary_price' => 'AllOfShopShippingProfileUpgradeSecondaryPrice',
...
self::TYPE__1,        ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['upgrade_id'] = isset($data['upgrade_id']) ? $data['upgrade_id'] : null;
     ...
     *
     * @param int $shipping_profile_id The numeric ID of the base shipping profile.
     *
     * @return $this
     */
     ...
     * Sets language
     *
     * @param string $language The IETF language tag for the language of the shipping profile. Ex: `de`, `en`, `es`, `fr`, `it`, `ja`, `nl`, `pl`, `pt`
     *
     * @return $this
     */
     ...
     * Gets price
     *
     * @return AllOfShopShippingProfileUpgradePrice
     */
     ...
     * Sets price
     *
     * @param AllOfShopShippingProfileUpgradePrice $price Additional cost of adding the shipping upgrade.
     *
     * @return $this
     */
     ...
     *
     * @return AllOfShopShippingProfileUpgradeSecondaryPrice
     */
     ...
     *
     * @param AllOfShopShippingProfileUpgradeSecondaryPrice $secondary_price Additional cost of adding the shipping upgrade for each additional item.
     *
     * @return $this
     */
