...
/**
 * ReturnReturnPolicyIdBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ReturnReturnPolicyIdBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'return_return_policy_id_body';
...
'return_deadline' => 'getReturnDeadline'    ];
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['accepts_returns'] === null) {
            $invalidProperties[] = "'accepts_returns' can't be null";
        }
        if ($this->container['accepts_exchanges'] === null) {
            $invalidProperties[] = "'accepts_exchanges' can't be null";
        }
     ...
     *
     * @param bool $accepts_returns accepts_returns
     *
     * @return $this
     */
     ...
     *
     * @param bool $accepts_exchanges accepts_exchanges
     *
     * @return $this
     */
