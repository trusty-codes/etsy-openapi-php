...
/**
 * ListingIdInventoryBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListingIdInventoryBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'listing_id_inventory_body';
    ...
    protected static $swaggerTypes = [
        'products' => '\Swagger\Client\Model\V3applicationlistingslistingIdinventoryProducts[]',
...
'sku_on_property' => 'getSkuOnProperty'    ];
     ...
     * Gets products
     *
     * @return \Swagger\Client\Model\V3applicationlistingslistingIdinventoryProducts[]
     */
     ...
     * Sets products
     *
     * @param \Swagger\Client\Model\V3applicationlistingslistingIdinventoryProducts[] $products A JSON array of products available in a listing, even if only one product. All field names in the JSON blobs are lowercase.
     *
     * @return $this
     */
