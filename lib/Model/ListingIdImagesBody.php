...
/**
 * ListingIdImagesBody Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ListingIdImagesBody implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'listing_id_images_body';
...
'alt_text' => 'getAltText'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['rank'] = isset($data['rank']) ? $data['rank'] : 1;
        $this->container['overwrite'] = isset($data['overwrite']) ? $data['overwrite'] : false;
        $this->container['is_watermarked'] = isset($data['is_watermarked']) ? $data['is_watermarked'] : false;
        $this->container['alt_text'] = isset($data['alt_text']) ? $data['alt_text'] : '';
    }
     ...
     * Sets image
     *
     * @param string $image The file name string of a file to upload
     *
     * @return $this
     */
     ...
     * Sets overwrite
     *
     * @param bool $overwrite When true, this request replaces the existing image at a given rank.
     *
     * @return $this
     */
     ...
     * Sets is_watermarked
     *
     * @param bool $is_watermarked When true, indicates that the uploaded image has a watermark.
     *
     * @return $this
     */
